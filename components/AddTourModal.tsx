...
const AddTourModal = ({ isOpen, onClose }: AddTourModalProps) => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const payload = {
      ...
      gallery: [data.image], // Use the main image as the initial gallery
    };
          ...
          <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-[1000] p-4">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-8">
                <form id="add-tour-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  {error && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        ...
                        {/* Hidden field for react-hook-form to catch the value */}
              ...
              <div className="p-6 border-t border-stone-100 bg-stone-50 flex gap-4">
                ...
                <button
                  ...
                  className="flex-[2] btn-gold flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                  ...
                  <span>{isSubmitting ? "Creating Tour..." : "Add Tour Package"}</span>
                </button>
              </div>
            </motion.div>
          </div>
